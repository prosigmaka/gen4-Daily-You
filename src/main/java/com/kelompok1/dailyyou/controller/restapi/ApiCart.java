...
public class ApiCart {
    ...
    @PostMapping("/add")
    public ResponseEntity<ApiResponse> addToCart(@RequestBody AddToCartDto addToCartDto, Users user){
    ...
    @GetMapping("/")
    public ResponseEntity<CartDto> getCartItems(Users user) {
        CartDto cartDto = cartService.listCartItems(user);
        return new ResponseEntity<CartDto>(cartDto,HttpStatus.OK);
    }
    @PutMapping("/update/{cartItemId}")
    public ResponseEntity<ApiResponse> updateCartItem(@RequestBody AddToCartDto cartDto, Users user){
    ...
    public ResponseEntity<ApiResponse> deleteCartItem(@PathVariable("cartItemId") int itemId, Users user) {
